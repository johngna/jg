...
<!-- begin::Body -->
<body class="kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-login__signin">
                        ...
                        <form class="kt-form" action="{{route('frontend.auth.cliente.login')}}" method="POST">
                            ...
                            <div class="kt-login__actions">
                                <input type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">
                            </div>
                        </form>
                    </div>
                    <div class="kt-login__signup">
                        <div class="kt-login__head">
                            ...
                            <div class="kt-login__desc">Informe os dados abaixo para o cadastro:</div>
                        </div>
                        <form class="kt-form" action="">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="password" placeholder="Confirme a senha" name="rpassword">
                            </div>
                            <div class="row kt-login__extra">
                                <div class="col kt-align-left">
                                    <label class="kt-checkbox">
                                        <input type="checkbox" name="agree">Eu concordo com os <a href="#" class="kt-link kt-login__link kt-font-bold">termos e condições</a>.
                                        <span></span>
                                    </label>
                            ...
                            <div class="kt-login__actions">
                                <button id="kt_login_signup_submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Cadastrar</button>&nbsp;&nbsp;
                    ...
                    <div class="kt-login__forgot">
                        <div class="kt-login__head">
                            ...
                            <div class="kt-login__desc">Informe seu email:</div>
                        </div>
                        <form class="kt-form" action="">
                            <div class="input-group">
                            ...
                            <div class="kt-login__actions">
                                <button id="kt_login_forgot_submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Solicitar</button>&nbsp;&nbsp;
